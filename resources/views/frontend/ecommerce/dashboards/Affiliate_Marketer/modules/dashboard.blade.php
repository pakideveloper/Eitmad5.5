   ...
   <!--  </div> -->
     <div class="row">
    	...
    	<div class="col-sm-12">
                  ...
                  <form class="form" action="{{url('ecommerce/marketer/dashboard')}}" method="post" id="registrationForm"  enctype="multipart/form-data">
  ...
  <div class="file-select">
    ...
    @if ($errors->has("image"))
            ...
            <div class="col-sm-8">                          
                      ...
                      <div class="form-group"> 
                          <div class="col-xs-6">
                             <label for="country"><h4>Payment Method</h4></label>
