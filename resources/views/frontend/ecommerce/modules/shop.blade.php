...
<!-- Mirrored from template.8guild.com/bushido/v1.4/shop-filters-left-2cols.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 29 Aug 2018 05:04:12 GMT -->
<head>
    <meta charset="utf-8">
            ...
            <div class="col-lg-8 col-md-8 col-sm-8">
              <div class="row">
                ...
                <div class="col-lg-6 col-md-6 col-sm-12">
                  <div class="tile">
                    <div class="price-label">715,00 $</div>
                    <a href="#"><src="{{URL::to('public/frontend/ecommerce/assets')}}/img/catalog/tiles/4.jpg" alt="4"/></a>
                    <div class="footer">
