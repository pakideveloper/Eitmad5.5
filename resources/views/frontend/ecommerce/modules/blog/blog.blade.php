...
<!-- Mirrored from template.8guild.com/bushido/v1.4/blog-sidebar-right.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 29 Aug 2018 05:04:24 GMT -->
<head>
    <meta charset="utf-8">
    <title>Blog - Eitmad</title>
    <!--SEO Meta Tags-->
  ...
  <body>
    ...
    <div class="page-content">
      	...
      	<div class="container">
        	<div class="row">
              ...
              <div class="post">
                ...
                <footer>
                	<a class="btn btn-success" href="{{url('/ecommerce/singleblog')}}">Read more</a>
                  <div class="share">
                  ...
                  <ul class="meta">
                    ...
                    <li><i class="fa fa-comment"></i><a href="{{URL::to('public/frontend/ecommerce/assets')}}/#">Comments (34)</a></li>
                 	</ul>
                </footer>
             </div>
              ...
              <div class="post">
                ...
                <footer>
                  ...
                  <ul class="meta">
                 		<li><i class="fa fa-user"></i><a href="{{URL::to('public/frontend/ecommerce/assets')}}/#">By Bedismo</a></li>
                    <li><i class="fa fa-calendar"></i><a href="{{URL::to('public/frontend/ecommerce/assets')}}/#">28.05.2014</a></li>
                    <li><i class="fa fa-comment"></i><a href="{{URL::to('public/frontend/ecommerce/assets')}}/#">Comments (25)</a></li>
                 	</ul>
                </footer>
             </div>
            </div>
            ...
            <div class="col-lg-3 col-md-3">
              ...
              <div class="latest-posts">
              	<div class="post">
                	<a href="{{URL::to('public/frontend/ecommerce/assets')}}/blog-single.html">New awesome theme out there...</a>
                  <div class="meta">
              	...
              	<div class="post">
                	<a href="{{URL::to('public/frontend/ecommerce/assets')}}/blog-single.html">Lorem ipsum dolor sit amet...</a>
                  <div class="meta">
              	...
              	<div class="post">
                	<a href="{{URL::to('public/frontend/ecommerce/assets')}}/blog-single.html">Anim pariatur cliche reprehenderit...</a>
                  <div class="meta">
      ...
      </section><!--Blog Sidebar Right Close-->
...
<!-- Mirrored from template.8guild.com/bushido/v1.4/blog-sidebar-right.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 29 Aug 2018 05:04:25 GMT -->
</html>
