...
<head>
    ...
    <body>
        ...
        <section class="position-relative cover-background tz-builder-bg-image border-none hero-style9 bg-img-one" id="home" data-img-size="(W)1920px X (H)961px" style="height: -webkit-fill-available; background:linear-gradient(rgba(35,31,41,0.7), rgba(35,31,41,0.7)), url('{{URL::to('public/frontend/general/assets')}}/images/bg-image/banner1.jpg')">
