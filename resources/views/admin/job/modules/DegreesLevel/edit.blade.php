                            ...
                            <div class="col-xs-12">
                                <div class="card-box">
                                    ...
                                    <div class="row">
                                            ...
                                            <h4 class="header-title m-t-0">Edit Degree Level</h4>
                                            
                                            <form action="{{url('/jobs/admin/degree_levels/')}}/{{$degreelevel->id}}" method="post" enctype="multipart/form-data" >
                                                    {{csrf_field()}}
                                                    {{ method_field('PUT')}}
                                                    <div class="form-group col-sm-6 col-md-6 {{$errors->has('degree_level_name') ? 'has-error' : ''}}>
                                                        ...
                                                        <input type="text" name="degree_level_name" parsley-trigger="change"
                                                               placeholder="Enter Degree Level" class="form-control" value="{{$degreelevel->degree_level_name}}">
