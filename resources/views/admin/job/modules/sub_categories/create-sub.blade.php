                ...
                <div class="content">
                    ...
                    <div class="container">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="card-box">
                                    <h4 class="header-title m-t-0">Job Sub Category Form</h4>
										 <div class="row">
										 	<div class="col-sm-12 col-xs-12 col-md-6">
										 	 	<div class="p-20">
                                    <form action="{{url('/jobs/admin/job_subcategories')}}" method="post">
                                        {{ csrf_field()}}
                                        <div class="form-group">
                                                    <label for="parentcategory">Choose Parent Job Category *:</label>
                                                    <select id="parentcategory" name="jcategory" class="form-control" required="">
                                                        <option > Choose Parent Category</option>
                                                        @foreach($jcategory as $jcategory_detail)   
                                                        <option value="{{$jcategory_detail->id}}">{{$jcategory_detail->job_category_name}}</option>
                                                        @endforeach
                                                    </select>
                                       ...
                                       <div class="form-group">
                                                        ...
                                                        <input type="text" name="jscategory" parsley-trigger="change" required
                                                               placeholder="Enter Sub category name" class="form-control" id="jcategory" >
                                                                @if ($errors->has('job_sub_category_name'))
                                                            <ul class="parsley-errors-list filled" id="parsley-id-5"><li class="parsley-required">{{ $errors->first('job_sub_category_name') }}.</li></ul>
                                                        @endif
                                                    </div>
