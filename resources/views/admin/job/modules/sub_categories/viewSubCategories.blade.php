                        ...
                        <div class="row">
                            <div class="col-xs-12">
                                <div class="page-title-box">
                                    <h4 class="page-title"> Job SubCategories</h4>
                                    <ol class="breadcrumb p-0 m-0">
                                        <li>
                                            <a href="#">Eitmad</a>
                                        </li>
                                        <li>
                                            <a href="#">Job SubCategories </a>
                                        </li>
                                        <li class="active">
                                        ...
                                        <div class="table-responsive" data-pattern="priority-columns">
                                            <table id="tech-companies-1" class="table  table-striped">
                                                <thead>
                                                    <tr>
                                                        <th>Id</th>
                                                        <th data-priority="1">Job Sub_Category_Name</th>
                                                ...
                                                <tbody>
                                                    @foreach($jscategory as $jscategory_detail)
                                                    <tr>
                                                        
                                                        <td>{{$jscategory_detail->id}}</td>
                                                        <th>{{$jscategory_detail->job_sub_category_name}}</th>
                                                        <th>{{$jscategory_detail->category->job_category_name}}</th>
                                                        <td>{{$jscategory_detail->created_at}}</td>
                                                        <td>{{$jscategory_detail->updated_at}}</td>
                                                        <td>
                                                            <a href="{{url('/jobs/admin/job_subcategories')}}/{{\Crypt::encrypt($jscategory_detail->id)}}/edit"  style="float: left;">
                                                                <i class="fa fa-pencil"></i>
                                                            </a>
                                                           <form id="delete-form{{$jscategory_detail->id}}" 
                                                                action="{{url('/jobs/admin/job_subcategories')}}/{{\Crypt::encrypt($jscategory_detail->id)}}" method="post">
                                                                {{csrf_field() }}
                                                                {{ method_field('DELETE') }}
                                                                 
                                                                <i  onclick="return deletejscategory_detail({{$jscategory_detail->id}});" class="fa fa-trash-o" style="cursor: pointer;"></i>
