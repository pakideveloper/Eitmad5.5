                                    ...
                                    <h4 class="header-title m-t-0">Edit Sub Category Form</h4>
										 <div class="row">
										 	<div class="col-sm-12 col-xs-12 col-md-6">
										 	 	<div class="p-20">
                                <form action="{{url('/jobs/admin/job_subcategories')}}/{{$jscategory->id}}" method="post">
                                        {{ csrf_field()}}
                                        {{ method_field('PUT')}}
                                       ...
                                       <div class="form-group">
                                                        ...
                                                        <input type="text" name="jscategory" parsley-trigger="change" required
                                                               placeholder="Enter Sub category name" class="form-control" id="pcategory" value="{{$jscategory->job_sub_category_name}}">
                                                                @if ($errors->has('job_sub_category_name'))
                                                            <ul class="parsley-errors-list filled" id="parsley-id-5"><li class="parsley-required">{{ $errors->first('job_sub_category_name') }}.</li></ul>
                                                        @endif
                                                    </div>                                   
