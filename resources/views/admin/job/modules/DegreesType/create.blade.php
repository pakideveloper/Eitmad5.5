                            ...
                            <div class="col-xs-12">
                                ...
                                <div class="card-box">
                                    ...
                                    <div class="row">
                                            ...
                                            <h4 class="header-title m-t-0">Create Degree Type</h4>
                                            
                                                <form action="{{url('/jobs/admin/degree_types')}}" method="post" enctype="multipart/form-data" >
                                                    {{csrf_field()}}
                                                    <div class="form-group col-sm-6 col-md-6 {{$errors->has('degree_type_name') ? 'has-error' : ''}}>
                                                        ...
                                                        <input type="text" name="degree_type_name" parsley-trigger="change"
                                                               placeholder="Enter Degree Type" class="form-control" value="{{ old('degree_type_name') }}">
