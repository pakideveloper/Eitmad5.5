                            ...
                            <div class="col-xs-12">
                                <div class="card-box">
                                    ...
                                    <div class="row">
                                            ...
                                            <h4 class="header-title m-t-0">Edit Industry</h4>
                                            
                                            <form action="{{url('/ecommerce/admin/industries/')}}/{{$industry->id}}" method="post" enctype="multipart/form-data" >
                                                    {{csrf_field()}}
                                                    {{ method_field('PUT')}}
                                                    ...
                                                    placeholder="Enter Industry Name" class="form-control" value="{{$industry->industry_name}}">
