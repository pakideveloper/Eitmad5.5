                        				...
                        				<div class="col-md-6 m-t-50">
                        					<form action="{{url('/ecommerce/admin/discount')}}" method="post" enctype="multipart/form-data">
	                                            ...
	                                            <div class="form-group{{ $errors->has('discount_name') ? ' has-error' : '' }}">
	                                                ...
	                                                <input type="text" class="form-control" name="discount_name" id="exampleInputEmail1" placeholder="Enter discount name" value="{{ old('discount_name') }}">
                                                     @if ($errors->has('discount_name'))
                                                        <span class="help-block">
                                                             <strong class="error">{{ $errors->first('discount_name') }}</strong>
                                                         </span>
                                                     @endif
	                                            </div>
	                                            <div class="form-group{{ $errors->has('discount_type') ? ' has-error' : '' }}">
	                                                <label for="exampleInputPassword1">Discount Type</label>
	                                                <input type="text" class="form-control" name="discount_type" id="exampleInputPassword1" placeholder="Enter discount type" value="{{ old('discount_type') }}">
                                                    @if ($errors->has('discount_type'))
                                                        <span class="help-block">
                                                             <strong class="error">{{ $errors->first('discount_type') }}</strong>
                                                         </span>
                                                     @endif
	                                            </div>
