                                            ...
                                            <div class="col-md-6">
                                                <div class="p-20">
                                                    <div class="form-group m-b-20 {{$errors->has('name') ? 'has-error' : ''}}">
                                                        ...
                                                        <input type="text" name="name" class="form-control" id="name" placeholder="Enter name" @if (count($errors) > 0) value="{{ old('name') }}" @else value="{{$role->name}}" @endif >
                                                        @if ($errors->has('name'))
                                                    ...
                                                    <div class="form-group m-b-20 {{$errors->has('display_name') ? 'has-error' : ''}}">
                                                        ...
                                                        <input type="text" name="display_name" class="form-control" id="display-name" placeholder="Enter display name"  @if (count($errors) > 0) value="{{ old('display_name') }}" @else value="{{$role->display_name}}" @endif>
                                                    ...
                                                    <div class="form-group m-b-20 {{$errors->has('description') ? 'has-error' : ''}}">
                                                        ...
                                                        <input type="text" name="description" class="form-control" id="description" placeholder="Enter description" @if (count($errors) > 0) value="{{ old('description') }}" @else value="{{$role->description}}" @endif>
                                                    ...
                                                    <div class="form-group m-b-20">
                                                        ...
                                                        <div class="row">
                                                            <div class="col-xs-12"><br><br>
                                                                ...
                                                                <div class="col-xs-12">
                                                                    <input type="checkbox" id="checkbox{{$permission ->id}}"  data-plugin="switchery" data-color="#2b3d51" data-size="small" name="permission[]" value="{{$permission -> id}}" {{in_array($permission->id,$role_permissions)?"checked":""}}/>
