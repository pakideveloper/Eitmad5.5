                            ...
                            <div class="col-sm-12">
                                <div class="card-box">
                                    ...
                                    <div class="table-rep-plugin">
                                        <h4 class="m-t-0 header-title"><b>All Cities</b></h4>
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <th>{{$city->city_code}}</th>
                                                         <th>{{$city->country->country_name}}</th>
                                                        <th>{{$city->region->region_name}}</th>
                                                        ...
                                                        <td>
                                                            ...
                                                            <form id="delete-form{{$city->id}}" 
                                                                action="{{url('/ecommerce/admin/cities')}}/{{$city->id}}" method="post">
                                                                {{csrf_field() }}
                                                                {{ method_field('DELETE') }}
                                                                 
                                                                <i  onclick="return deleteCountry({{$city->id}});" class="fa fa-trash-o" style="cursor: pointer;"></i>
