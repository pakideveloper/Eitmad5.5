                            ...
                            <div class="col-sm-12">
                                <div class="card-box">
                                    ...
                                    <div class="table-rep-plugin">
                                        <h4 class="m-t-0 header-title"><b>All Countries</b></h4>
                                            ...
                                            <table id="tech-companies-1" class="table  table-striped">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <a href="{{url('/ecommerce/admin/countries')}}/{{\Crypt::encrypt($country->id)}}/edit" style="float: left;">
                                                                <i class="fa fa-pencil"></i>
                                                            </a>
                                                            <form id="delete-form{{$country->id}}" 
                                                                action="{{url('/ecommerce/admin/countries')}}/{{$country->id}}" method="post">
                                                                {{csrf_field() }}
                                                                {{ method_field('DELETE') }}
                                                                 
                                                                <i  onclick="return deleteCountry({{$country->id}});" class="fa fa-trash-o" style="cursor: pointer;"></i>
